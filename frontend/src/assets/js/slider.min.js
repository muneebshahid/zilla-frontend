    ...
    _createRange: function() {
      ...
      b.range
        ? (b.range === !0 &&
          ...
          this.range.addClass(
            c + ("min" === b.range || "max" === b.range ? " ui-slider-range-" + b.range : "")
          ))
    ...
    _mouseCapture: function(b) {
      ...
      return (
        ...
        this.handles.each(function(b) {
          ...
          (e > c || (e === c && (b === k._lastChangedValue || k.values(b) === l.min))) &&
            ((e = c), (f = a(this)), (g = b));
        }),
        (h = this._start(b, g)),
        h !== !1 &&
    ...
    _refreshValue: function() {
      ...
      this.options.values && this.options.values.length
            ...
            (c = ((i.values(d) - i._valueMin()) / (i._valueMax() - i._valueMin())) * 100),
              ...
              i.options.range === !0 &&
                ("horizontal" === i.orientation
                  ? (0 === d &&
                      i.range.stop(1, 1)[j ? "animate" : "css"]({ left: c + "%" }, h.animate),
                    1 === d &&
                  ...
                  : (0 === d &&
                      i.range.stop(1, 1)[j ? "animate" : "css"]({ bottom: c + "%" }, h.animate),
                    1 === d &&
                      i.range[j ? "animate" : "css"](
                        { height: c - b + "%" },
                        { queue: !1, duration: h.animate }
        ...
        : ((d = this.value()),
          ...
          "min" === g &&
            "horizontal" === this.orientation &&
            this.range.stop(1, 1)[j ? "animate" : "css"]({ width: c + "%" }, h.animate),
          "max" === g &&
            "horizontal" === this.orientation &&
          ...
          "min" === g &&
            ...
            this.range.stop(1, 1)[j ? "animate" : "css"]({ height: c + "%" }, h.animate),
          "max" === g &&
            "vertical" === this.orientation &&
            this.range[j ? "animate" : "css"](
              { height: 100 - c + "%" },
    ...
    _handleEvents: {
      keydown: function(b) {
        ...
        switch (
          ((f = this.options.step),
          (d = e =
            this.options.values && this.options.values.length ? this.values(g) : this.value()),
          b.keyCode)
        ) {
          case a.ui.keyCode.HOME:
            e = this._valueMin();
